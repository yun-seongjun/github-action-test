...
export interface CheckBoxAllAtomProps extends Omit<
...
const getVariants = (iconName: IconNamesEnum) => {
  switch (iconName) {
    ...
    case IconNamesEnum.CheckboxIndeterminate:
...
const CheckBoxAllAtom = forwardRef<HTMLInputElement, CheckBoxAllAtomProps>(
  (
    {
      wrapperClassName,
      iconClassName,
      ...
      >
        ...
        {indeterminate && checked ? (
          <CheckBoxIcon
            ...
            iconName={IconNamesEnum.CheckboxIndeterminate}
...
CheckBoxAllAtom.displayName = 'CheckBox';

export default CheckBoxAllAtom;
